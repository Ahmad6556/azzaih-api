...
function azzaihf(URL, U_s, N_s) {
    ...
    حذف ${localStorage.getItem(N_s)}
    </button>
    <br>
    <link rel="stylesheet" href="/iframe.css">
    <iframe id="yyy" src="${URL}" title="يا عباس | إصدار يا محرم | حسين فيصل | محرم 1438" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
    </iframe>`;
}
